...
_REASON_SHAPE_IN = (
    "consomme une forme, et l'évaluateur n'en fabrique pas "
    "(un rappel du kernel, comme pour le nœud Python, lèverait ce blocage)"
)
...
GRAPH_NODES: tuple[GraphNode, ...] = (
    ...
    # --- Courbes / surfaces : nombres et points → instruction ; le kernel
    #     traduit en Part. Ceux qui consomment une forme restent grisés. ---
    ...
    _gn("arc", "Arc", "Arc (Deg)", "curves", "nodes_arc.svg",
        ...
        + _num("angle1", "angle2"), implemented=True, shape=True),
    ...
    _gn("ligne", "Ligne", "Line (2 Pts)", "curves", "nodes_line.svg",
        inputs=_pts("point1", "point2"), implemented=True, shape=True),
    ...
    _gn("courbe_vers_surface", "Courbe vers surface", "Crv to Srf",
        ...
        reason=_REASON_SHAPE_IN, shape=True),
...
GRAPH_INPUT_LABELS: dict[str, tuple[str, str]] = {
    ...
    "ferme": ("Fermé", "Closed"),
    "centres": ("Points de passage", "Through Points"),
    "courbe": ("Courbe", "Curve"),
